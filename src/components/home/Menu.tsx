...
export default function Menu() {
  ...
  // Fetch categories and products using RTK Query hooks
  ...
  const categories = [
    {
      id: "all",
      name: "All Items",
      count: productData?.data?.length || 0,
    },
  ...
  const filteredItems =
    activeCategory === "all"
      ? productData?.data || []
      : productData?.data?.filter(
          (item:any) => item.categoryId.toString() === activeCategory
        ) || [];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            the finest ingredients and utmost attention to detail.
          </p>
        </div>
